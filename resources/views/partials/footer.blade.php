<footer id="footer" style="background-image: url('{{ asset('images/footer-bg.jpg') }}')">
    <section class="links">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        ...
                        <div class="col-12 pb-3">
                            <div class="text-secondary">
                                All Sites Content TM and © 2020 DC Entertainment, unless otherwise <span class="cursor_pointer">noted here</span>. All rights reserved.
                ...
                <div class="col-6 h-100">
                    <img src="{{ asset('images/dc-logo-bg.png') }}" alt="img logo background">
                </div>
            </div>
        </div>
    </section>
